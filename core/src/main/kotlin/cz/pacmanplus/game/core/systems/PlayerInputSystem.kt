...
class PlayerInputSystem : IteratingSystem(Aspect.all(PlayerInputComponent::class.java)) {

    override fun process(entityId: Int) {
        val playerInputComponent = world.getEntity(entityId).getComponent(PlayerInputComponent::class.java)
